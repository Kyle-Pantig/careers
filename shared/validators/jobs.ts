...
export const jobSchema = z.object({
  ...
  experienceMin: z.coerce.number().min(0, 'Minimum experience must be 0 or more').max(50, 'Maximum 50 years').default(0),
  experienceMax: z.coerce.number().min(0).max(50).optional().nullable(),
  salaryMin: z.coerce.number().min(0, 'Salary must be positive').optional().nullable(),
  salaryMax: z.coerce.number().min(0, 'Salary must be positive').optional().nullable(),
